export const StoryLine = {
  ...
  8: {
    ...
    text: `<img id="old-man" src="./imagesfolder/elf.png">
      <div id="welcome">
  ...
  9: {
    ...
    text: `<img id="old-man" src="./imagesfolder/swordinstone.png">
      <div id="welcome">
...
//  The cowhand realises that the true villain of this piece is Lactose Intolerance.
  ...
  10: {
    ...
    header: `<h2>You talk about Cows for hours. The cowhand, enraged, charges!.</h2>`,
    text: `<img id="old-man" src="./imagesfolder/charge.png">
    <div id="welcome">
    <h2 id="main-text">"I challenge you to a battle!</h2>
    </div>`,
  },
  11: {
    button1: "*Continue drinking!*",
  ...
  12: {
    ...
    text: `<img id="old-man" src="./imagesfolder/cows.png">
    <div id="welcome">
  ...
  13: {
    ...
    text: `<img id="old-man" src="./imagesfolder/peace.png">
    <div id="welcome">
  ...
  14:{
    ...
    text: `<img id="old-man" src="./imagesfolder/evil.png">
    `,
  }, 
  ...
  15: {
    ...
    text: `<img id="old-man" src="./imagesfolder/sword.png">
    <div id="welcome">
  ...
  16: {
    ...
    text: `<img id="old-man" src="./imagesfolder/death.png">
    <div id="welcome">
  ...
  21: {
    ...
    text: `<img id="old-man" src="./imagesfolder/war.png">
    <div id="welcome">
  ...
  22: {
    button1: "Restart",
    button2: "",
    header: `<h2>The Witch accidentally is covered in the sacred Milk and dies of Dysentry.</h2>`,
    text: `<img id="old-man" src="./imagesfolder/ruler.png">
    <div id="welcome">
